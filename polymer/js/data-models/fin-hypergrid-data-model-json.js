    ...
    Polymer('fin-hypergrid-data-model-json', { /* jshint ignore:line  */
        ...
        */
        setFields: function(fieldNames) {
            this.getData().setFields(fieldNames);
        },
        ...
        */
        ...
        getRow: function(y) {
            ...
            return this.getData().getRow(index);
        },
        ...
        */
        ...
        setGroups: function(arrayOfColumnIndexes) {
            this.getData().setGroups(arrayOfColumnIndexes);
            this.groups = arrayOfColumnIndexes;
        },
