...
var Hypergrid = Base.extend('Hypergrid', {
    ...
    /**
     * @param {object} [options]
     * @param {object} [options.include] - Hash of special objects to exclude. To exclude one or more of `rows`, `columns`, `cells`, `subgrids`, `calculators`, `columnIndexes`, or `columnNames`, provide an object with those key(s) with value `false`.
