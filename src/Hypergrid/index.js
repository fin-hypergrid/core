 ...
 * @param {DataModel} [options.metadata] - _Passed to behavior {@link Behavior constructor}._
 * * A schema array
...
var Hypergrid = Base.extend('Hypergrid', {
     ...
     * @param {DataModel} [options.metadata] - Value to be passed to setMetadataStore if the data model has changed.
     ...
     * @param {DataModel} [options.metadata] - _Passed to behavior {@link Behavior constructor} (when `options.Behavior` given)._
