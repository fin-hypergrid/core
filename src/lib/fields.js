...
var api = {
     ...
     * @returns {Array.<{name:string,header:string}>} Array object also decroated with synonyms for elements.
     */
     ...
     *
     * @param {Array.<string|Object<string,string>>} schema
     * @returns {Array.<{index:number,name:string,header:string}>}
     */
     ...
     * @returns {Array.<{index:number,name:string,header:string}>} Array object also decroated with synonyms for elements.
     */
