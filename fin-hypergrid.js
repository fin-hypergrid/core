...
(function() {
    ...
    Polymer({ /* jslint ignore:line */
        ...
        doColumnMoveAnimation: function(floaterStartX, draggerStartX) {
            ...
            return function() {
                ...
                window.requestAnimationFrame(function() {
                    ...
                    d.style.webkitTransform = 'translate(' + draggerStartX + 'px, ' + -2 + 'px)';
                });
                self.repaint();
        ...
        createFloatColumn: function(colIndex) {
            ...
            style.zIndex = '4';
            style.webkitTransform = 'translate(' + startX + 'px, ' + -2 + 'px)';
            style.cursor = 'none';
            this.repaint();
        },
        ...
        createDragColumn: function(x, colIndex) {
            ...
            style.webkitTransform = 'translate(' + x + 'px, -5px)';
            style.zIndex = '5';
            style.cursor = 'none';
            this.repaint();
